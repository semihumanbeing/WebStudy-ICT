...
<script type="text/javascript">
	...
	function search() {
		...
		// 검색내용 parameter로 list.do 호출
		location.href = "list.do?search=" + search + "&searchText="
	...
	<div id="box">
		...
		<div style="text-align: center; margin: 10px">
			<select id="search">
				...
				<option value="nameContent">이름+내용</option>
			</select> <input id="searchText" value="${param.searchText}"> <input
			...
			<form>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div>
							비밀번호<input type="password" id="cfmPwd"> <input
								class="btn btn-success" type="button" value="수정"
								onclick="update(this.form);"> <input
