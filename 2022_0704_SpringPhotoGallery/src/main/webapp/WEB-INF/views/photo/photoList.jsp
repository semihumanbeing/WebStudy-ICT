	...
	function photoView(p_idx){
		...
		$.ajax({
			...
			success: function(resData){
				// 팝업윈도우 배치작업
				$("#photoimg").attr('src','../resources/upload/'+resData.p_filename);
				$("#photoSubject").html(resData.p_subject);
				$("#photoContent").html(resData.p_content);
				$("#photoRegidate").html(resData.p_regdate);
	...
	<div id="box">
		...
		<div id="photoBox">
			...
			<c:forEach var="vo" items="${list}">
				<div class="photo">
					<img src="../resources/upload/${vo.p_filename}" onclick="photoView('${vo.p_idx}');">
